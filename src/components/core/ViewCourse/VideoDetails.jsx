...
const VideoDetails = () => {
  ...
  return (
    <div className="flex flex-col gap-2 text-white mt-5 rounded-md">
      {!videoData ? (
        <img
          src={previewSource}
          alt="Preview"
      ...
      <div className="pl-5 flex flex-col gap-1 mb-10">
        <div className="flex gap-2 items-center  mt-2">
          <MdOutlineOndemandVideo size={23} className="pt-1" />
        ...
        <div className="flex gap-1 pl-6  items-center">
          ...
          <p className="text-richblack-500">{videoData?.description}</p>
        </div>
      </div>
    </div>
  );
