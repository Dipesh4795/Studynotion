...
export default function CourseInformationForm() {
  ...
  useEffect(() => {
    const getCategories = async () => {
      ...
      console.log("corsecategories", courseCategories);
      setLoading(false);
    };
  ...
  const isFormUpdated = () => {
    ...
    if (
      ...
      currentValues.coursePrice.toString() !== course.price ||
  ...
  const onSubmit = async (data) => {
    ...
    if (editCourse) {
      ...
      if (isFormUpdated()) {
        ...
        if (currentValues.coursePrice?.toString() !== course.price) {
    ...
    >
      ...
      <div className="flex flex-col space-y-2">
        ...
        <select
          ...
          defaultValue=""
          id="courseCategory"
          className="form-style w-full text-white pr-8 "
        >
          ...
          {!loading &&
            courseCategories?.map((category, indx) => (
              <option key={indx} value={category?._id} className="mb-3 py-8">
